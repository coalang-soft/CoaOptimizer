...
public enum InstructionData {
    ...
    __java(InstructionCategory.JAVA), putM(InstructionCategory.PUT), nnr2(InstructionCategory.NOT_NULL_RETURN),
    __println_c(null), __mkvar(null), invoke1(null), __setvar(null);
